const { app, BrowserWindow, BrowserView, Menu, screen, dialog, accelerator, WebContents, webContents, MenuItem, ipcRenderer} = require('electron')
...
// // GET GIO VOLUMES
// ipcMain.on('get_gio_volumes', (e) => {
//     let cmd = "gio mount -l | grep 'Volume(0)'"
//     let gio_volumes = exec(cmd)
//     gio_volumes.stdout.on('data', (data) => {
//         e.sender.send('gio_volumes', data.split('\n').split(':'))
//     })
// })
